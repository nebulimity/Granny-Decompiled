...
public class resetDay : MonoBehaviour
{
	...
	{
		door1.GetComponent<Animation>().Play("InnerdoorClose_1");
		door2.GetComponent<Animation>().Play("InnerdoorClose_1");
		door3.GetComponent<Animation>().Play("InnerdoorClose_1");
		door4.GetComponent<Animation>().Play("InnerdoorClose_1");
		door5.GetComponent<Animation>().Play("SmallDoorClose_1");
		door6.GetComponent<Animation>().Play("SmallDoorClose_1");
		door7.GetComponent<Animation>().Play("Garde1Close_0");
		door8.GetComponent<Animation>().Play("Garde1Close_0");
		door9.GetComponent<Animation>().Play("Garde1Close_0");
		door10.GetComponent<Animation>().Play("SmallDoorClose_1");
